    ...
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
          ...
          <div class="card-sub">已配对的设备和实时连接。</div>
        </div>
...
function renderTokenRow(deviceId: string, token: DeviceTokenSummary, props: NodesProps) {
  ...
  const scopes = `权限：${formatList(token.scopes)}`;
    ...
    <section class="card">
      <div class="row" style="justify-content: space-between; align-items: center;">
        <div>
          ...
          <div class="card-sub">
            在使用 <span class="mono">exec host=node</span> 时将 agent 固定到特定节点。
          </div>
        </div>
        <button
          class="btn"
            ...
            <div class="list" style="margin-top: 16px;">
              <div class="list-item">
                <div class="list-main">
                  ...
                  <div class="list-sub">当 agent 未覆盖节点绑定时使用。</div>
                </div>
                <div class="list-meta">
                  <label class="field">
                    <span>节点</span>
...
function renderExecApprovalsPolicy(state: ExecApprovalsState) {
  ...
  return html`
    <div class="list" style="margin-top: 16px;">
      ...
      <div class="list-item">
        <div class="list-main">
          <div class="list-title">询问后备</div>
          <div class="list-sub">
            ${isDefaults ? "在 UI 提示不可用时应用。" : `默认：${defaults.askFallback}。`}
          </div>
        </div>
        <div class="list-meta">
          <label class="field">
        ...
        <div class="list-sub">
          ...
          ${
            bindingValue === "__default__"
              ? `使用默认值（${state.defaultBinding ?? "any"}）`
              : `覆盖：${agent.binding}`
          }
        </div>
      </div>
